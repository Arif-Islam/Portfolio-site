  ...
  return (
    <div>
      ...
      <div className="min-h-screen">
        <p className="text-center text-2xl font-medium text-white pt-14 md:pt-20">
          {project?.name}
        </p>
        <p className="text-center font-light text-white pt-2 w-[300px] lg:w-[500px] mx-auto pb-10">
          {project?.subtitle}
        </p>
        ...
        <div className="mt-7 flex items-center justify-center gap-3 flex-wrap pb-12">
          <a href={project?.livesite} target="_blank">
            <button className="bg-purple-700 text-white px-4 py-1 rounded transition duration-300 ease-in-out hover:bg-purple-900">
              Live Site
            </button>
          </a>
