...
const Intro = () => {
    return (
        <div className='py-24 w-11/12 mx-auto 2xl:w-full'>
            <div className='flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-0 '>
                <div className='flex flex-col items-start md:-mt-6 max-w-[400px] md:max-w-none'>
                    ...
                    <p className='text-white text-[40px] font-semibold pt-2 tracking-wider'>Md Ariful Islam</p>
                ...
                <div className='flex '>
                    <img className='w-[400px] lg:w-[500px] transform duration-500 hover:-translate-y-2 rounded-1/2 shadow-xl   hover:cursor-pointer hover:-rotate-3' src={img2} alt="" />
                </div>
            </div>
        </div>
    );
